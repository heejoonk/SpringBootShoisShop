...
<section>
	...
	<article>
		<form  action="join" method="post" name="joinForm"  id="joinFrm">
			...
			<div class="field">
				<label>Extra Address</label><input type="text" id="sample6_extraAddress" name="address3"  value="${dto.address3}"/>
			</div>
			...
			<div class="btn">
				<input type="button" value="회원가입" onclick="go_save()">
			   	<input type="button" value="메인으로" onClick="location.href='shop.do?command=main'">	
			</div>			
		</form>
	</article>
</section>
