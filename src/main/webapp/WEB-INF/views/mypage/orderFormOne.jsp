	...
	<article>
		<form name="cartFrm" method="post">
					...
					<div class="tb">
						...
						<div class="row">
							<div class="col" style="flex:1; justify-content: flex-start;">
								<c:if test="${not empty loginUser.zip_num}">
									...
									onClick="loadAddress('${loginUser.zip_num}', '${loginUser.address1}', '${loginUser.address2}', '${loginUser.address3}')">
									로그인유저와 주소가 동일합니다
								</c:if>
							</div>
						</div>
						...
						<div class="row">
							...
							<div class="row">
								...
								<div class="col"><fmt:formatNumber value="${product.price2}" 	type="currency" /></div>
								<div class="col">
			...
			<div class="btn">
				...
				<input type="button" value="주문하기"   onclick="go_orderInsertOne()">
			</div>
		</form>
	</article>
</section>
